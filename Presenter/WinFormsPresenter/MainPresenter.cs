...
namespace Presenter.WinFormsPresenter
{
    public class MainPresenter
    {
        ...
        public MainPresenter(IMainView mainView, IShipManager shipManager, IHelper helper, IFlagColorManager flagColorManager)
        {
            ...
            mainView.OnHelpTextRequested += inModelGetHelpText;
            helper.OnHelpTextRequested += inViewGetHelpText;
            ...
            mainView.InitializeMainFormFirstTime();
        }
        ...
        /// <summary>
        /// Передает в представление текст хэлпа
        /// </summary>
        /// <param name="sender">Объект, вызвавший событие</param>
        /// <param name="e">Данные для события</param>
        public void inViewGetHelpText(object sender, OnHelpTextRequestedEventArgs e)
        {
            mainView.ShowHelp(e.HelpText);
        }

        /// <summary>
        /// Просит у модели текст хэлпа
        /// </summary>
        public void inModelGetHelpText()
        {
            helper.GetHelpText();
        }
